...
Next up, we will find another datasource, and attempt to create a model in order to make some predictions about our data.
Check it out here at [Deliverable 2](deliverable2.html).

### 3. Results and Operationalization

We have arrived at the end. In this deliverable, we will be looking back at our work and forming opinions on how we can operationalize our findings. Come check it out. [Deliverable 3](deliverable3.html).
